...
export default function CustomerForms({ register, setValue, watch }: Props) {
  ...
  return (
    <>
      {/* Buyer */}
      <CardSection icon={<User className="w-4 h-4" />} title="Thông tin người đặt">
        <div className="space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1.5">Họ tên <span className="text-destructive">*</span></p>
            ...
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1.5">Số điện thoại <span className="text-destructive">*</span></p>
      ...
      {isGifting && (
        <CardSection>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1.5">Họ tên người nhận <span className="text-destructive">*</span></p>
              <InputIcon icon={<User className="w-4 h-4" />}>
                <input
